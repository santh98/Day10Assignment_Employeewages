...
{
    public default void addCompany(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs) {
    ...
    default int getTotalEmpWage() {
        return getTotalEmpWage(null);
    }
